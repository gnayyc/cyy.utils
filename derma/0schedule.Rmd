...
[Schedule Link](https://docs.google.com/spreadsheets/d/18NQX3J2LxYY7K_FJgmk_Sf88G0-a64SxCj_c8OxQgd) | [Registration Link](https://goo.gl/forms/jltRvjPFhYYvqme82)  
...
#	    lesion == last_lesion ~ max(registry_date + months(6), last_registry_date + months(1), na.rm=T), 
#	    T ~ last_registry_date + months(1)
#                                 )
#  ) %>%
#  select(CID, last_lesion, lesion, registry_date, photo_date, registry_date, interval, next_photo_date, next_registry_date) %>%
